...
######################################################################################
#Images
ImgBalloon = pygame.image.load('C:\MaNguonMo\app_project\Balloon-Pop-Game-Using-Python-OpenCV-main\Ballon Pop (Pygame)\Images_Project.png').convert_alpha()

ImgBalloon_2 = pygame.image.load('C:\MaNguonMo\app_project\Balloon-Pop-Game-Using-Python-OpenCV-main\Ballon Pop (Pygame)\Images_Project.png').convert_alpha()
ImgBalloon_2 = pygame.transform.scale(ImgBalloon_2,(115,200))

ImgBalloon_3 = pygame.image.load('C:\MaNguonMo\app_project\Balloon-Pop-Game-Using-Python-OpenCV-main\Ballon Pop (Pygame)\Images_Project.png').convert_alpha()
ImgBalloon_3 = pygame.transform.scale(ImgBalloon_3,(200,250))

ImgPop = pygame.image.load('C:\MaNguonMo\app_project\Balloon-Pop-Game-Using-Python-OpenCV-main\Ballon Pop (Pygame)\Images_Project.png').convert_alpha()
